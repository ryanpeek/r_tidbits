# numbats from tidytuesday:
# https://github.com/BjnNowak/TidyTuesday/blob/main/SC_numbats.R
...
# load map
world <- rnaturalearthdata::map_units110 %>% st_as_sf()
#world <- sf::read_sf("Data/Erosion/data/world_map/ne_110m_admin_0_countries_lakes_guy.shp")
ndvi <-
  raster::raster("data_raw/ndvi_australia_2020_modis_1000m.tif")
summary(ndvi)
