...
# bm_grid <- st_read("data/BlackMarbleTiles/BlackMarbleTiles.shp") #%>%
#   #st_transform(3310)
# st_crs(bm_grid)
...
v <- vect("data/BlackMarbleTiles/BlackMarbleTiles.shp")
...
# Read Data ---------------------------------------------------------------
# IRL
r1 <- terra::rast('data/VNP46A2.A2020080.h17v03.001.2021062011031.h5')
r1 <- terra::rast('data/VNP46A2.A2022030.h17v03.001.2022047162659.h5')

# CA
r1 <- terra::rast('data/VNP46A2.A2022030.h05v05.001.2022047154547.h5')
